...
// Function to fetch and display assigned requests
async function loadAssignedRequests() {
    ...
    try {
        ...
        querySnapshot.forEach((docSnap) => {
            ...
            if (data.status && data.status.toLowerCase() === "assigned") {
                found = true;
        ...
        if (!found) {
            tableBody.innerHTML = "<tr><td colspan='8' style='text-align:center;'>No Assigned Requests</td></tr>";
        }
...
// Load assigned requests on page load
document.addEventListener("DOMContentLoaded", loadAssignedRequests);
