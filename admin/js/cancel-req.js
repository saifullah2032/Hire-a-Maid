...
// Function to fetch and display canceled requests
async function loadCanceledRequests() {
    ...
    try {
        ...
        if (!found) {
            tableBody.innerHTML = "<tr><td colspan='8' style='text-align:center;'>No Canceled Requests</td></tr>";
        }
...
// Load canceled requests on page load
document.addEventListener("DOMContentLoaded", loadCanceledRequests);
